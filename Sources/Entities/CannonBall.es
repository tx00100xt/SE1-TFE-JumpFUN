...
//######################                       ST8VI MOD                          ###########################	
//########################################################################################################### 	  
  FLOAT _st8_fCannonPower = GetSP()->sp_st8_fCannonPower;
  _st8_fCannonPower = Clamp(_st8_fCannonPower, (float)1.0f, (float)1.25f);  
  FLOAT fMaxDamage = IRON_DAMAGE_MAX*_st8_fCannonPower;
  if(m_cbtType == CBT_NUKE)
  {
    fMaxDamage = IRON_DAMAGE_MAX*_st8_fCannonPower;
  }
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################
