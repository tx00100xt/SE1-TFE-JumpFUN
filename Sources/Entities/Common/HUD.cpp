...
struct WeaponInfo _awiWeapons[18] = {
  ...
  { WEAPON_PIPEBOMB,        &_toWPipeBomb,        &_aaiAmmo[3], FALSE }, //{ WEAPON_PIPEBOMB,        &_toWPipeBomb,        &_aaiAmmo[3], FALSE },   // 10
...
extern void InitHUD(void)
{
  ...
  try {
	...
	_toWPipeBomb.SetData_t(        CTFILENAME("TexturesMP\\Interface\\WPipeBomb.tex"));
