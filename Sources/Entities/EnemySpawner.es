...
INDEX  _bModifySpawners;
FLOAT  _fEnemySpawnerGroupSizeMultiplier;
FLOAT  _fEnemySpawnerCountMultiplier;
FLOAT  _fEnemySpawnerDelayMultiplier;
FLOAT  _fEnemySpawnerCircleMultiplier;
...
//########### Enemy multi count #######################################
    if (GetSP()->sp_rf_bModifySpawners) {
      _fEnemySpawnerGroupSizeMultiplier = GetSP()->sp_rf_fEnemySpawnerGroupSizeMultiplier;
      _fEnemySpawnerCountMultiplier = GetSP()->sp_rf_fEnemySpawnerCountMultiplier;
      _fEnemySpawnerDelayMultiplier = GetSP()->sp_rf_fEnemySpawnerDelayMultiplier;
      _fEnemySpawnerCircleMultiplier = GetSP()->sp_rf_fEnemySpawnerCircleMultiplier;

      m_ctGroupSize   *= _fEnemySpawnerGroupSizeMultiplier;
      m_ctTotal       *= _fEnemySpawnerCountMultiplier;
	  m_tmDelay       *= _fEnemySpawnerDelayMultiplier;
	  m_tmSingleWait  *= _fEnemySpawnerDelayMultiplier;
	  m_tmGroupWait   *= _fEnemySpawnerDelayMultiplier;

	  if(m_fOuterCircle == 0) {
		m_fOuterCircle = 1.0f;
	  }
	  m_fOuterCircle *= _fEnemySpawnerCircleMultiplier;
