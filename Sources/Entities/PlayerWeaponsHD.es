...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
	const INDEX _st8_bDisableAllWeapons = GetSP()->sp_st8_bDisableAllWeapons;
	const INDEX _st8_bGiveAllWeapons = GetSP()->sp_st8_bGiveAllWeapons;
	
	const INDEX _st8_bDisableCannon = GetSP()->sp_st8_bDisableCannon;
	const INDEX _st8_bDisableGrenades = GetSP()->sp_st8_bDisableGrenades;
	const INDEX _st8_bDisableKnife = GetSP()->sp_st8_bDisableKnife;
	//const INDEX _st8_bDisableChainSaw = GetSP()->sp_st8_bDisableChainSaw;
	const INDEX _st8_bDisableColt = GetSP()->sp_st8_bDisableColt;
	const INDEX _st8_bDisableDoubleColt = GetSP()->sp_st8_bDisableDoubleColt;
	const INDEX _st8_bDisableSingleShotgun = GetSP()->sp_st8_bDisableSingleShotgun;
	const INDEX _st8_bDisableDoubleShotgun = GetSP()->sp_st8_bDisableDoubleShotgun;
	const INDEX _st8_bDisableTommygun = GetSP()->sp_st8_bDisableTommygun;
	const INDEX _st8_bDisableMinigun = GetSP()->sp_st8_bDisableMinigun;
	//const INDEX _st8_bDisableFlamer = GetSP()->sp_st8_bDisableFlamer;
	const INDEX _st8_bDisableLaser = GetSP()->sp_st8_bDisableLaser;
	//const INDEX _st8_bDisableSniper = GetSP()->sp_st8_bDisableSniper;
	const INDEX _st8_bDisableRLauncher = GetSP()->sp_st8_bDisableRLauncher;
	const INDEX _st8_bEnableGhostBuster = GetSP()->sp_st8_bEnableGhostBuster;
	const INDEX _st8_bEnablePipeBomb = GetSP()->sp_st8_bEnablePipeBomb;
	
	if(_st8_bDisableAllWeapons == 1 || _st8_bGiveAllWeapons == 1){
	
		m_iAvailableWeapons |= 1<<(WEAPON_IRONCANNON     -1);
		m_iAvailableWeapons |= 1<<(WEAPON_GRENADELAUNCHER-1);	 
		m_iAvailableWeapons |= 1<<(WEAPON_KNIFE			 -1); 
		//m_iAvailableWeapons |= 1<<(WEAPON_CHAINSAW	 	 -1);
		m_iAvailableWeapons |= 1<<(WEAPON_COLT    		 -1);
		m_iAvailableWeapons |= 1<<(WEAPON_DOUBLECOLT     -1);
		m_iAvailableWeapons |= 1<<(WEAPON_SINGLESHOTGUN  -1);
		m_iAvailableWeapons |= 1<<(WEAPON_DOUBLESHOTGUN  -1);
		m_iAvailableWeapons |= 1<<(WEAPON_TOMMYGUN       -1);
		m_iAvailableWeapons |= 1<<(WEAPON_MINIGUN        -1);
		//m_iAvailableWeapons |= 1<<(WEAPON_FLAMER         -1);
		m_iAvailableWeapons |= 1<<(WEAPON_LASER          -1);
		//m_iAvailableWeapons |= 1<<(WEAPON_SNIPER   		 -1);
		m_iAvailableWeapons |= 1<<(WEAPON_ROCKETLAUNCHER -1);
		m_iAvailableWeapons |= 1<<(WEAPON_GHOSTBUSTER    -1);
		m_iAvailableWeapons |= 1<<(WEAPON_PIPEBOMB       -1);
		
	} 
	if( _st8_bDisableAllWeapons == 1 && _st8_bGiveAllWeapons == 0){
	...
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableCannon == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_IRONCANNON     -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_IRONCANNON     -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableGrenades == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_GRENADELAUNCHER-1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_GRENADELAUNCHER-1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableKnife == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_KNIFE    		 -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_KNIFE   		 -1);
		
	}
//	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableChainSaw == 1){
//		m_iAvailableWeapons |= 1<<(WEAPON_CHAINSAW    		 -1);	
//		m_iAvailableWeapons ^= 1<<(WEAPON_CHAINSAW    		 -1);
		
//	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableColt == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_COLT    		 -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_COLT    		 -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableDoubleColt == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_DOUBLECOLT    		 -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_DOUBLECOLT    		 -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableSingleShotgun == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_SINGLESHOTGUN  -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_SINGLESHOTGUN  -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableDoubleShotgun == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_DOUBLESHOTGUN  -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_DOUBLESHOTGUN  -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableTommygun == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_TOMMYGUN       -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_TOMMYGUN       -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableMinigun == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_MINIGUN        -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_MINIGUN        -1);
		
	}
//	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableFlamer == 1){
//		m_iAvailableWeapons |= 1<<(WEAPON_FLAMER         -1);	
//		m_iAvailableWeapons ^= 1<<(WEAPON_FLAMER         -1);
		
//	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableLaser == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_LASER          -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_LASER          -1);
		
	}
//	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableSniper == 1){
//		m_iAvailableWeapons |= 1<<(WEAPON_SNIPER   		 -1);	
//		m_iAvailableWeapons ^= 1<<(WEAPON_SNIPER   		 -1);
		
//	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bDisableRLauncher == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_ROCKETLAUNCHER -1);	
		m_iAvailableWeapons ^= 1<<(WEAPON_ROCKETLAUNCHER -1);
		
	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bEnableGhostBuster == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_GHOSTBUSTER -1);

	}
	if(_st8_bDisableAllWeapons == 0 && _st8_bGiveAllWeapons == 0 && _st8_bEnablePipeBomb == 1){
		m_iAvailableWeapons |= 1<<(WEAPON_PIPEBOMB -1);
...
//      case 7: return WEAPON_FLAMER;
      case 7: return WEAPON_GHOSTBUSTER;
...
/*
      ...
      case WEAPON_PIPEBOMB:
        ...
        WeaponSelectOk(WEAPON_KNIFE);
        break;
      case WEAPON_LASER:  case WEAPON_GHOSTBUSTER: // case WEAPON_FLAMER:
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
    FLOAT _st8_fColtPower = GetSP()->sp_st8_fColtPower;
	_st8_fColtPower = Clamp(_st8_fColtPower, (float)1.0f, (float)10.0f);
	// fire bullet
    FireOneBullet(wpn_fFX[WEAPON_COLT], wpn_fFY[WEAPON_COLT], 500.0f,
      //((GetSP()->sp_bCooperative) ? 10.0f : 20.0f));
	  _st8_fColtPower*10.0f);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################
...
//###########################################################################################################	
   FLOAT _st8_fColtPower = GetSP()->sp_st8_fColtPower;  
   _st8_fColtPower = Clamp(_st8_fColtPower, (float)1.0f, (float)10.0f);
   FireOneBullet(wpn_fFX[WEAPON_DOUBLECOLT], wpn_fFY[WEAPON_DOUBLECOLT], 500.0f, _st8_fColtPower*10.0f);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################	
    if(_pNetwork->IsPlayerLocal(m_penPlayer)) {IFeel_PlayEffect("Colt_fire");}
...
//######################                       ST8VI MOD                          ###########################	
//########################################################################################################### 	  
    FLOAT _st8_fSingleShotgunPower = GetSP()->sp_st8_fSingleShotgunPower;	 
	 _st8_fSingleShotgunPower = Clamp(_st8_fSingleShotgunPower, (float)1.0f, (float)10.0f);
      FireBullets(wpn_fFX[WEAPON_SINGLESHOTGUN], wpn_fFY[WEAPON_SINGLESHOTGUN],      
		//500.0f, 10.0f, 7, afSingleShotgunPellets, 0.2f, 0.03f);
		500.0f, 10.0f*_st8_fSingleShotgunPower, 7, afSingleShotgunPellets, 0.2f, 0.03f);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################		
      DoRecoil();
...
//###########################################################################################################
	  ...
	  FLOAT _st8_fSingleShotgunFireSpeed = GetSP()->sp_st8_fSingleShotgunFireSpeed;	
      _st8_fSingleShotgunFireSpeed = Clamp(_st8_fSingleShotgunFireSpeed, (float)1.0f, (float)10.0f);
	  autowait(GetSP()->sp_bCooperative ? 0.5f/_st8_fSingleShotgunFireSpeed : 0.375);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################	  
      /* drop shell */
...
//###########################################################################################################		  
		  ...
		  //FLOAT _st8_fSingleShotgunFireSpeed = GetSP()->sp_st8_fSingleShotgunFireSpeed;
		  (GetSP()->sp_bCooperative ? 0.5f*GetSP()->sp_st8_fSingleShotgunFireSpeed : 0.375f) );
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################		  
...
//######################                       ST8VI MOD                          ###########################	
//########################################################################################################### 	  
     FLOAT _st8_fDoubleShotgunPower = GetSP()->sp_st8_fDoubleShotgunPower;
	  _st8_fDoubleShotgunPower = Clamp(_st8_fDoubleShotgunPower, (float)1.0f, (float)10.0f);
      FireBullets(wpn_fFX[WEAPON_DOUBLESHOTGUN], wpn_fFY[WEAPON_DOUBLESHOTGUN],       
		//500.0f, 10.0f, 14, afDoubleShotgunPellets, 0.3f, 0.03f);
		500.0f, 10.0f*_st8_fDoubleShotgunPower, 7, afDoubleShotgunPellets, 0.2f, 0.03f);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################       
      DoRecoil();
...
//###########################################################################################################
	  ...
	  FLOAT _st8_fDoubleShotgunFireSpeed = GetSP()->sp_st8_fDoubleShotgunFireSpeed;
	  _st8_fDoubleShotgunFireSpeed = Clamp(_st8_fDoubleShotgunFireSpeed, (float)1.0f, (float)10.5f);
	  autowait(GetSP()->sp_bCooperative ? 0.25f/_st8_fDoubleShotgunFireSpeed : 0.15f);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################	  
      if (m_iShells>=2) {
...
//###########################################################################################################
		...
		//FLOAT _st8_fDoubleShotgunFireSpeed = GetSP()->sp_st8_fDoubleShotgunFireSpeed;
		(GetSP()->sp_bCooperative ? 0.25f*GetSP()->sp_st8_fDoubleShotgunFireSpeed : 0.15f) );
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################		
      // no ammo -> change weapon
...
//######################                       ST8VI MOD                          ###########################	
//########################################################################################################### 	  
	  FLOAT _st8_fTommygunPower = GetSP()->sp_st8_fTommygunPower;	  
	  _st8_fTommygunPower = Clamp(_st8_fTommygunPower, (float)1.0f, (float)10.0f);      
      FireMachineBullet(wpn_fFX[WEAPON_TOMMYGUN], wpn_fFY[WEAPON_TOMMYGUN], 
        
		//500.0f, 10.0f, ((GetSP()->sp_bCooperative) ? 0.01f : 0.03f),
		500.0f, 10.0f*_st8_fTommygunPower, ((GetSP()->sp_bCooperative) ? 0.01f : 0.03f),
...
//###########################################################################################################
      //autowait(0.1f);
	  FLOAT _st8_fTompsonFireSpeed = GetSP()->sp_st8_fTompsonFireSpeed;		  
	  _st8_fTompsonFireSpeed = Clamp(_st8_fTompsonFireSpeed, (float)1.0f, (float)10.5f);
	  autowait(0.1f/_st8_fTompsonFireSpeed);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################	  
      // no ammo -> change weapon
...
//######################                       ST8VI MOD                          ###########################	
//########################################################################################################### 	  
	  FLOAT  _st8_fMinigunPower = GetSP()->sp_st8_fMinigunPower;	
	    _st8_fMinigunPower = Clamp(_st8_fMinigunPower, (float)1.0f, (float)10.0f);
        FireMachineBullet(wpn_fFX[WEAPON_MINIGUN], wpn_fFY[WEAPON_MINIGUN],
          //750.0f, 10.0f, (GetSP()->sp_bCooperative) ? 0.01f : 0.03f, 
		  750.0f, 10.0f*_st8_fMinigunPower, (GetSP()->sp_bCooperative) ? 0.01f : 0.03f, 
          ( (GetSP()->sp_bCooperative) ? 0.5f : 0.0f));
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################		
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
      	FLOAT  _st8_fRocketDelay = GetSP()->sp_st8_fRocketDelay;	
		//FLOAT  _st8_fRocketFireSpeed = GetSP()->sp_st8_fRocketFireSpeed;	    
	 _st8_fRocketDelay = Clamp(_st8_fRocketDelay, (float)0.0f, (float)0.05f);
	  if(_st8_fRocketDelay != 0.0f) { autowait(_st8_fRocketDelay); }// 0.05f
	  //autowait(0.05f); // 0.05f
	  
      CModelObject *pmo = &(m_moWeapon.GetAttachmentModel(ROCKETLAUNCHER_ATTACHMENT_ROCKET1)->amo_moModelObject);
      pmo->StretchModel(FLOAT3D(0, 0, 0));

	  FLOAT  _st8_fRocketFireSpeed = GetSP()->sp_st8_fRocketFireSpeed;
	  _st8_fRocketFireSpeed = Clamp(_st8_fRocketFireSpeed, (float)0.05f, (float)0.7f);
	  autowait(m_moWeapon.GetAnimLength(ROCKETLAUNCHER_ANIM_FIRE)-_st8_fRocketFireSpeed); // 0.05f
	  //autowait(m_moWeapon.GetAnimLength(ROCKETLAUNCHER_ANIM_FIRE)-0.05f); // 0.05f
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################	
		FLOAT  _st8_fLaserFireSpeed = GetSP()->sp_st8_fLaserFireSpeed;	     
	 _st8_fLaserFireSpeed = Clamp(_st8_fLaserFireSpeed, (float)0.01f, (float)0.1f);
	  autowait(_st8_fLaserFireSpeed); // 0,1f
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################	  
  ...
  FireGhostBuster() {
    ...
    if (m_iElectricity>0) {
      ...
      DecAmmo(m_iElectricity, 1);
      SpawnRangeSound(20.0f);
      autowait(0.025f); // autowait(0.05f);
      // no napalm -> change weapon
      if (m_iElectricity<=0) { SelectNewWeapon(); }
    } else {
