...
void CProjectile_OnPrecache(CDLLEntityClass *pdec, INDEX iUser) 
{
  ...
  case PRT_LASER_RAY:
	...
	pdec->PrecacheModel(MODEL_LASER_GIZMO             );
	pdec->PrecacheTexture(TEXTURE_BLUE_LASER          );
	pdec->PrecacheTexture(TEXTURE_GREEN_LASER_GIZMO   );
...
// ********* PLAYER LASER *********
 ...
 53 model   MODEL_LASER_GIZMO           "Models\\Enemies\\Gizmo\\Gizmo.mdl",
 54 texture TEXTURE_GREEN_LASER_GIZMO   "Models\\Enemies\\Gizmo\\Gizmo.tex",
 55 texture TEXTURE_BLUE_LASER_GIZMO    "Models\\Enemies\\Gizmo\\Gizmo.tex",
...
// ********* DEMON FIREBALL *********
150 model   MODEL_DEMON_FIREBALL    "Models\\Enemies\\Demon\\Projectile\\Projectile.mdl",
151 texture TEXTURE_DEMON_FIREBALL  "Models\\Enemies\\Demon\\Projectile\\Projectile.tex",
152 sound   SOUND_DEMON_FLYING      "Sounds\\Weapons\\ProjectileFly.wav",
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################  
  FLOAT _st8_fRocketSpeed = GetSP()->sp_st8_fRocketSpeed;
  // _st8_fRocketSpeed = Clamp(_st8_fRocketSpeed, (float)-30.0f, (float)-300.0f);
  // _st8_fRocketSpeed = -30.0f 
  if(_st8_fRocketSpeed > -1.0f) {_st8_fRocketSpeed = -1.0f;}
  if(_st8_fRocketSpeed < -300.0f) {_st8_fRocketSpeed = -300.0f;}
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, _st8_fRocketSpeed), (CMovableEntity*)(CEntity*)m_penLauncher); 
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################  
  ...
  {
    FLOAT _st8_fRLauncherPower = GetSP()->sp_st8_fRLauncherPower;
	_st8_fRLauncherPower = Clamp(_st8_fRLauncherPower, (float)1.0f, (float)10.0f);
	m_fDamageAmount = 100.0f*_st8_fRLauncherPower; // 100 default
//###########################################################################################################	
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
	//m_fRangeDamageAmount = 75.0f;
	FLOAT _st8_fRangeDamageAmount = GetSP()->sp_st8_fRangeDamageAmount;
	_st8_fRangeDamageAmount = Clamp(_st8_fRangeDamageAmount, (float)10.0f, (float)75.0f);
	m_fRangeDamageAmount = _st8_fRangeDamageAmount;
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################
  }
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
  FLOAT _st8_fWalkerWeaponMode = GetSP()->sp_st8_fWalkerWeaponMode;
  if(_st8_fWalkerWeaponMode == 0.0f){
	SetModel(MODEL_ROCKET);
  }else{
  ...
  // _st8_fWalkerRocketSpeed = -30.0f
  FLOAT _st8_fWalkerRocketSpeed = GetSP()->sp_st8_fWalkerRocketSpeed;
  if(_st8_fWalkerRocketSpeed > -1.0f) {_st8_fWalkerRocketSpeed = -1.0f;}
  if(_st8_fWalkerRocketSpeed < -60.0f) {_st8_fWalkerRocketSpeed = -60.0f;}
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, _st8_fWalkerRocketSpeed), (CMovableEntity*)(CEntity*)m_penLauncher); 
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################   
  SetDesiredRotation(ANGLE3D(0, 0, 0));
...
//######################                       ST8VI MOD                          ###########################	
//########################################################################################################### 
  FLOAT  _st8_fGrenadesPower = GetSP()->sp_st8_fGrenadesPower;
  _st8_fGrenadesPower = Clamp(_st8_fGrenadesPower, (float)0.0f, (float)10.0f);
  m_fRangeDamageAmount = 100.0f*_st8_fGrenadesPower;
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################     
  m_fDamageHotSpotRange = 4.0f;
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
  FLOAT _st8_fPlayerLaserWeaponMode = GetSP()->sp_st8_fPlayerLaserWeaponMode;  
  if(_st8_fPlayerLaserWeaponMode == 3.0f){
	SetModel(MODEL_LASER_GIZMO);
  }else{
...
//######################                       ST8VI MOD                          ###########################	
//###########################################################################################################
  if(_st8_fPlayerLaserWeaponMode == 1.0f){
	SetModelMainTexture(TEXTURE_BLUE_LASER);
  //}else if(_st8_fPlayerLaserWeaponMode == 2.0f) {
  //	SetModelMainTexture(TEXTURE_GRUNT_PROJECTILE_02);
  }else if(_st8_fPlayerLaserWeaponMode == 3.0f) {
	SetModelMainTexture(TEXTURE_GREEN_LASER_GIZMO);
  }else{
